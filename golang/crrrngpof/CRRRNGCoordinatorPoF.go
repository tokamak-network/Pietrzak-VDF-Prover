...
//
// Solidity: function getUserStatusAtRound(address _operator, uint256 _round) view returns((uint256,uint256,bool))
...
//
// Solidity: function getValuesAtRound(uint256 _round) view returns((uint256,uint256,uint256,address,(bytes,uint256),uint8,bool,bool))
...
// LastFulfilledRoundNext is a free data retrieval call binding the contract method 0x4d41445e.
//
// Solidity: function lastFulfilledRoundNext() view returns(uint256)
func (_Crrrngpof *CrrrngpofCaller) LastFulfilledRoundNext(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Crrrngpof.contract.Call(opts, &out, "lastFulfilledRoundNext")
...
//
// Solidity: function lastFulfilledRoundNext() view returns(uint256)
func (_Crrrngpof *CrrrngpofSession) LastFulfilledRoundNext() (*big.Int, error) {
	return _Crrrngpof.Contract.LastFulfilledRoundNext(&_Crrrngpof.CallOpts)
}

// LastFulfilledRoundNext is a free data retrieval call binding the contract method 0x4d41445e.
//
// Solidity: function lastFulfilledRoundNext() view returns(uint256)
func (_Crrrngpof *CrrrngpofCallerSession) LastFulfilledRoundNext() (*big.Int, error) {
	return _Crrrngpof.Contract.LastFulfilledRoundNext(&_Crrrngpof.CallOpts)
}

// LastRecoveredRoundNext is a free data retrieval call binding the contract method 0x77ab295d.
//
// Solidity: function lastRecoveredRoundNext() view returns(uint256)
func (_Crrrngpof *CrrrngpofCaller) LastRecoveredRoundNext(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Crrrngpof.contract.Call(opts, &out, "lastRecoveredRoundNext")
...
//
// Solidity: function lastRecoveredRoundNext() view returns(uint256)
func (_Crrrngpof *CrrrngpofSession) LastRecoveredRoundNext() (*big.Int, error) {
	return _Crrrngpof.Contract.LastRecoveredRoundNext(&_Crrrngpof.CallOpts)
}

// LastRecoveredRoundNext is a free data retrieval call binding the contract method 0x77ab295d.
//
// Solidity: function lastRecoveredRoundNext() view returns(uint256)
func (_Crrrngpof *CrrrngpofCallerSession) LastRecoveredRoundNext() (*big.Int, error) {
	return _Crrrngpof.Contract.LastRecoveredRoundNext(&_Crrrngpof.CallOpts)
}
